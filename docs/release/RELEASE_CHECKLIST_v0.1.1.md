# ONOKO ARCANA v0.1.1 Release Checklist
...
- [ ] GitHub Actions success on the `v0.1.1` tag.
...
- The zip must include `LICENSE`, `SECURITY.md`, `DISTRIBUTION_NOTICE.md`, and `docs/legal/ASSET_LICENSE_AND_ATTRIBUTION.md`.
